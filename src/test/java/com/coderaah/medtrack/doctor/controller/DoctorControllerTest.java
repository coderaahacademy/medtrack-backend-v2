...
class DoctorControllerTest {
    ...
    @Test
    void registerDoctor_shouldReturn201AndResponseJson_whenRegistrationSucceeds()
            throws Exception {
        ...
        response.setLastName("Seife");
        response.setLicenseNumber("Lic-No-123");
        response.setProfessionalPhone("+982154567819");
        response.setTimeZone("Iran/Tehran");
        response.setActive(true);
                        ...
                        .content("""
                            {
                              "personId": 10,
                              "licenseNumber": "Lic-No-123",
                              "professionalPhone": "+982154567819",
                              "timeZone": "Iran/Tehran"
                            }
                            """))
    ...
    @Test
    void updateDoctor_shouldReturnUpdatedDoctor_whenRequestIsValid()
            throws Exception {
        ...
        response.setFirstName("Nastaran");
        response.setLastName("Seife");
        response.setLicenseNumber("Lic-No-456");
        response.setProfessionalPhone("+982154567819");
        response.setTimeZone("Iran/Tehran");
        response.setActive(true);
        ...
        mockMvc.perform(put("/api/doctors/1")
                        ...
                        .content("""
                            {
                              "licenseNumber": "Lic-No-456",
                              "professionalPhone": "+982154567819",
                              "timeZone": "Iran/Tehran"
                            }
                            """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.licenseNumber").value("Lic-No-456"))
                .andExpect(jsonPath("$.professionalPhone").value("+982154567819"))
                .andExpect(jsonPath("$.timeZone").value("Iran/Tehran"));
    }

    @Test
    void updateDoctorStatus_shouldReturnUpdatedStatus_whenRequestIsValid()
            throws Exception {
        ...
        when(doctorService.updateDoctorStatus(1L, false))
                .thenReturn(response);
    ...
    @Test
    void updateDoctorStatus_shouldReturn400_whenActiveIsMissing()
            throws Exception {
        ...
        verify(doctorService, never())
                .updateDoctorStatus(anyLong(), anyBoolean());
    }

    @Test
    void registerDoctor_shouldReturn400_whenPersonAlreadyHasDoctorProfile()
            throws Exception {

        // Arrange
        when(doctorService.registerDoctor(any(DoctorRequest.class)))
                .thenThrow(new DuplicateDoctorPersonException(
                        "Doctor profile for person with id 1 already exists"
                ));
    ...
    @Test
    void registerDoctor_shouldReturn400_whenBothPersonIdAndPersonAreProvided()
            throws Exception {

        // Arrange
        when(doctorService.registerDoctor(any(DoctorRequest.class)))
                .thenThrow(new InvalidDoctorRequestException(
    ...
    @Test
    void registerDoctor_shouldReturn400_whenNeitherPersonIdNorPersonIsProvided()
            throws Exception {
    ...
    @Test
    void registerDoctor_shouldReturn404_whenPersonDoesNotExist()
            throws Exception {

        // Arrange
        when(doctorService.registerDoctor(any(DoctorRequest.class)))
                .thenThrow(new DoctorPersonNotFoundException(
